...
data class BreathHoldRecord(
    ...
    @ColumnInfo(defaultValue = "0") val firstDiscomfortMillis: Long = 0L,
    @ColumnInfo(defaultValue = "0") val actualRecoveryDurationMillis: Long = 0L,
    @ColumnInfo(defaultValue = "''") val stopReason: String = "",
)
